...
OEM_PRODUCT_LIST := enchilada
OEM_PRODUCT_LIST += fajita
OEM_PRODUCT_LIST += fajitat
#OEM_PRODUCT_LIST += TODO
...
$(call inherit-product-if-exists, vendor/qcom/proprietary/commonsys/qrdplus/China/ChinaTelecom/products.mk)
endif

ifeq ($(strip $(TARGET_USES_QTIC_CU)),true)
# Include the QRD customer extensions for ChinaUnicom.
$(call inherit-product-if-exists, vendor/qcom/proprietary/commonsys/qrdplus/China/ChinaUnicom/products.mk)
endif

ifeq ($(strip $(TARGET_USES_QTIC_TARGET_USES_QTIC_REGIONAL)),true)
# Include the QRD customer extensions for Regional/MetroPCS/TMobile.
$(call inherit-product-if-exists, vendor/qcom/proprietary/commonsys/qrdplus/Global/*/products.mk)
endif

ifeq ($(strip $(TARGET_USES_QTIC_CTA)),true)
# Include the QRD customer extensions for CTA
$(call inherit-product-if-exists, vendor/qcom/proprietary/commonsys/qrdplus/China/CTA/products.mk)
endif
...
ifeq ($(strip $(TARGET_USES_QSSI)),true)
...
#ifdef VENDOR_EDIT
#xunanbin delete qcom fingerprint
# FINGERPRINT
...
#ifdef VENDOR_EDIT
#lifei@OnePlus.MultiMediaService, 2017/12/12,add dirac lib for 17819 version
...
MM_AUDIO += ftm_test_config_sm8150-tavil-qrd-snd-card
...
MM_CAMERA += com.qti.node.gpu
MM_CAMERA += com.qti.node.swregistration
##VENDOR_EDIT remove useless camera sensor
#MM_CAMERA += com.qti.sensormodule.altek_imx577.bin
#MM_CAMERA += com.qti.sensormodule.liteon_imx318.bin
#MM_CAMERA += com.qti.sensormodule.liteon_imx362.bin
#MM_CAMERA += com.qti.sensormodule.semco_imx258.bin
...
QMI += qrtr-ns
QMI += qrtr-lookup
# VENDOR_EDIT aaron add for sensor FTM test
QMI += libnanopb
#QOSMGR
QOSMGR := qosmgr
...
#SECUREMSM += vendor.qti.hardware.soter.xml
...
#ifdef VENDOR
#yanweibo add for widevine L1 20180503
...
#ifndef VENDOR_EDIT
#Remove for :TLOC (Trusted Location) will cause SARF test Fail
...
#ifdef VENDOR_EDIT
#lifei@OnePlus.MultiMediaService, 2017/12/102,add dirac lib for 17819 version
...
# VENDOR_EDIT aaron add for sensor FTM test
SENSORS_DBG += sns_client_example
